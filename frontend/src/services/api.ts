import { DisplayMessage, HistorySession, HistoryDetails, Scenario } from "../app/conversation/types";
...
export const sendAndEvaluateVoice = async (
    ...
    const res = await fetch(
        `${API_BASE_URL}/conversation/evaluate-scenario-voice`,
        {
            method: "POST",
...
export const sendFreeTalkVoice = async (
    ...
    const res = await fetch(
        `${API_BASE_URL}/conversation/chat/free-talk-voice`,
        {
            method: "POST",
            headers: authHeadersForm(),
            body: formData,
...
export const deleteConversation = async (
    ...
    const res = await fetch(`${API_BASE_URL}/conversation/delete/${sessionId}`, {
        method: "DELETE",
        headers: authHeaders(),
    });
